...
`),m="user_plans",w="user_accounts";function s(e){return{name:e.name??null,age:e.age??null,gender:e.gender??null,height:e.height??null,weight:e.weight??null,goal:e.goal??null,level:e.level??null,location:e.location??null,dietaryPrefs:e.dietaryPrefs??null,medicalHistory:e.medicalHistory??null,stressLevel:e.stressLevel??null}}function i(e){return{email:e.email,password_hash:e.password_hash,name:e.name,age:e.age,gender:e.gender,height:e.height?parseFloat(e.height):void 0,weight:e.weight?parseFloat(e.weight):void 0,goal:e.goal,level:e.level,location:e.location,dietaryPrefs:e.dietary_prefs,medicalHistory:e.medical_history,stressLevel:e.stress_level,created_at:e.created_at,updated_at:e.updated_at}}async function l(e){await g;let{rows:t}=await h.query(`select 
     ...
     set
       ...
       updated_at = now()
     where email = $1
     returning *`,[e,a.name,a.age,a.gender,a.height,a.weight,a.goal,a.level,a.location,a.dietaryPrefs,a.medicalHistory,a.stressLevel]);return r[0]?i(r[0]):null}e.s(["fetchPlanByEmail",()=>l,"fetchUserAccount",()=>d,"updateUserPassword",()=>u,"updateUserProfile",()=>p,"upsertPlanRecord",()=>o,"upsertUserAccount",()=>c]),a()}catch(e){a(e)}},!1),54799,(e,t,a)=>{t.exports=e.x("crypto",()=>require("crypto"))},24392,e=>e.a(async(t,a)=>{try{var r=e.i(54799),n=e.i(89171),s=e.i(15480),i=t([s]);async function l(e){try{let{email:t,newPassword:a}=await e.json();if(!t||!a)return n.NextResponse.json({error:"Missing email or new password"},{status:400});if(!await (0,s.fetchUserAccount)(t))return n.NextResponse.json({error:"User not found"},{status:404});let i=(0,r.createHash)("sha256").update(a).digest("hex");return await (0,s.updateUserPassword)(t,i),n.NextResponse.json({success:!0})}catch(e){return console.error("Error changing password:",e),n.NextResponse.json({error:"Failed to change password"},{status:500})}}[s]=i.then?(await i)():i,e.s(["POST",()=>l]),a()}catch(e){a(e)}},!1),49182,e=>e.a(async(t,a)=>{try{var r=e.i(47909),n=e.i(74017),s=e.i(96250),i=e.i(59756),l=e.i(61916),o=e.i(14444),d=e.i(37092),u=e.i(69741),c=e.i(16795),p=e.i(87718),h=e.i(95169),g=e.i(47587),m=e.i(66012),w=e.i(70101),y=e.i(26937),v=e.i(10372),f=e.i(93695);e.i(52474);var x=e.i(220),_=e.i(24392),E=t([_]);[_]=E.then?(await E)():E;let $=new r.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/user/change-password/route",pathname:"/api/user/change-password",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/user/change-password/route.ts",nextConfigOutput:"",userland:_}),{workAsyncStorage:D,workUnitAsyncStorage:U,serverHooks:P}=$;function R(){return(0,s.patchFetch)({workAsyncStorage:D,workUnitAsyncStorage:U})}async function C(e,t,a){$.isDev&&(0,i.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let r="/api/user/change-password/route";r=r.replace(/\/index$/,"")||"/";let s=await $.prepare(e,t,{srcPage:r,multiZoneDraftMode:!1});if(!s)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:_,params:E,nextConfig:R,parsedUrl:C,isDraftMode:D,prerenderManifest:U,routerServerContext:P,isOnDemandRevalidate:A,revalidateOnlyGenerated:b,resolvedPathname:N,clientReferenceManifest:j,serverActionsManifest:q}=s,L=(0,u.normalizeAppPath)(r),T=!!(U.dynamicRoutes[L]||U.routes[N]),S=async()=>((null==P?void 0:P.render404)?await P.render404(e,t,C,!1):t.end("This page could not be found"),null);if(T&&!D){let e=!!U.routes[N],t=U.dynamicRoutes[L];if(t&&!1===t.fallback&&!e){if(R.experimental.adapterPath)return await S();throw new f.NoFallbackError}}let H=null;!T||$.isDev||D||(H=N,H="/index"===H?"/":H);let O=!0===$.isDev||!T,k=T&&!O;q&&j&&(0,o.setReferenceManifestsSingleton)({page:r,clientReferenceManifest:j,serverActionsManifest:q,serverModuleMap:(0,d.createServerModuleMap)({serverActionsManifest:q})});let M=e.method||"GET",X=(0,l.getTracer)(),I=X.getActiveScopeSpan(),F={params:E,prerenderManifest:U,renderOpts:{experimental:{authInterrupts:!!R.experimental.authInterrupts},cacheComponents:!!R.cacheComponents,supportsDynamicResponse:O,incrementalCache:(0,i.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:R.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r)=>$.onRequestError(e,t,r,P)},sharedContext:{buildId:_}},K=new c.NodeNextRequest(e),B=new c.NodeNextResponse(t),z=p.NextRequestAdapter.fromNodeNextRequest(K,(0,p.signalFromNodeResponse)(t));try{let s=async e=>$.handle(z,F).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=X.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==h.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=a.get("next.route");if(n){let t=`${M} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${r}`)}),o=!!(0,i.getRequestMeta)(e,"minimalMode"),d=async i=>{var l,d;let u=async({previousCacheEntry:n})=>{try{if(!o&&A&&b&&!n)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let r=await s(i);e.fetchMetrics=F.renderOpts.fetchMetrics;let l=F.renderOpts.pendingWaitUntil;l&&a.waitUntil&&(a.waitUntil(l),l=void 0);let d=F.renderOpts.collectedTags;if(!T)return await (0,m.sendResponse)(K,B,r,F.renderOpts.pendingWaitUntil),null;{let e=await r.blob(),t=(0,w.toNodeOutgoingHttpHeaders)(r.headers);d&&(t[v.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==F.renderOpts.collectedRevalidate&&!(F.renderOpts.collectedRevalidate>=v.INFINITE_CACHE)&&F.renderOpts.collectedRevalidate,n=void 0===F.renderOpts.collectedExpire||F.renderOpts.collectedExpire>=v.INFINITE_CACHE?void 0:F.renderOpts.collectedExpire;return{value:{kind:x.CachedRouteKind.APP_ROUTE,status:r.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:n}}}}catch(t){throw(null==n?void 0:n.isStale)&&await $.onRequestError(e,t,{routerKind:"App Router",routePath:r,routeType:"route",revalidateReason:(0,g.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:A})},P),t}},c=await $.handleResponse({req:e,nextConfig:R,cacheKey:H,routeKind:n.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:U,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:b,responseGenerator:u,waitUntil:a.waitUntil,isMinimalMode:o});if(!T)return null;if((null==c||null==(l=c.value)?void 0:l.kind)!==x.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(d=c.value)?void 0:d.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});o||t.setHeader("x-nextjs-cache",A?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),D&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let p=(0,w.fromNodeOutgoingHttpHeaders)(c.value.headers);return o&&T||p.delete(v.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||p.get("Cache-Control")||p.set("Cache-Control",(0,y.getCacheControlHeader)(c.cacheControl)),await (0,m.sendResponse)(K,B,new Response(c.value.body,{headers:p,status:c.value.status||200})),null};I?await d(I):await X.withPropagatedContext(e.headers,()=>X.trace(h.BaseServerSpan.handleRequest,{spanName:`${M} ${r}`,kind:l.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},d))}catch(t){if(t instanceof f.NoFallbackError||await $.onRequestError(e,t,{routerKind:"App Router",routePath:L,routeType:"route",revalidateReason:(0,g.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:A})}),T)throw t;return await (0,m.sendResponse)(K,B,new Response(null,{status:500})),null}}e.s(["handler",()=>C,"patchFetch",()=>R,"routeModule",()=>$,"serverHooks",()=>P,"workAsyncStorage",()=>D,"workUnitAsyncStorage",()=>U]),a()}catch(e){a(e)}},!1)];

//# sourceMappingURL=%5Broot-of-the-server%5D__f1933773._.js.map