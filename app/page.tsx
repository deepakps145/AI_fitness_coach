...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden text-foreground neon-grid">
      ...
      <div className="absolute inset-x-0 top-0 h-64 bg-gradient-to-b from-cyan-500/20 via-transparent to-transparent blur-3xl" aria-hidden />
      <div className="absolute -left-24 top-40 h-72 w-72 rounded-full bg-purple-500/20 blur-3xl" aria-hidden />
      <div className="absolute -right-12 top-24 h-64 w-64 rounded-full bg-cyan-500/30 blur-3xl" aria-hidden />
      ...
      <section className="relative max-w-6xl mx-auto px-6 py-12 lg:py-20 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-7">
          ...
          >
            Autonomous AI plans for your body, voiced like a coach, visualized like a studio.
          </motion.h1>
          ...
          >
            Enter your stats, goals, and diet. FitAI instantly builds workout splits, macros, and daily meals, speaks
            them out with ElevenLabs, and renders exercises/meals so you can see and hear your plan.
          </motion.p>
          ...
          >
            <Badge>Gemini-generated plans</Badge>
            <Badge>Neon DB ready</Badge>
            <Badge>ElevenLabs voice</Badge>
            <Badge>AI images per item</Badge>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -top-14 -right-16 h-56 w-56 rounded-full bg-purple-500/25 blur-3xl" aria-hidden />
          <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-cyan-500/20 blur-3xl" aria-hidden />
          <div className="relative glass rounded-3xl p-6 shadow-2xl glow-ring border-white/10 bg-white/5">
